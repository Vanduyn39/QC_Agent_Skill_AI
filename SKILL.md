...
- **Hành động:**
  ...
  2. Bóc tách và map thông tin user đưa vào 15 trường: Fixed Build Version, Module, Defect Name(sumary), Description, Expect, Actual Result, Type, Severity, Priority, Status, Attachments, Reported By, DEV, Date, Note. Nếu trường nào không có thông tin, để trống (chuỗi rỗng).
  3. Gọi hàm `log_bug_to_project` trong `scripts/log_manager.py` với tham số `project_name` và dictionary chứa 15 trường trên.
...
## 4. Intent: Generate Test Case (Viết Test case/Checklist)
